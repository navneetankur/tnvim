...
impl Nvimapi {
    pub async fn get_autocmds<D: Deserialize<'static>>(
        &self,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn buf_get_var<D: Deserialize<'static>>(
        &self,
        buffer: Buffer,
        name: &str,
    ) -> error::Result<D> {
    ...
    pub async fn buf_get_keymap<D: Deserialize<'static>>(
        &self,
        buffer: Buffer,
        mode: &str,
    ) -> error::Result<D> {
    ...
    pub async fn buf_get_keymap_wv(
        &self,
        buffer: Buffer,
        mode: String,
    ) -> error::Result<Vec<Dict>> {
    ...
    pub async fn buf_set_keymap_wv(
        &self,
        buffer: Buffer,
        mode: String,
        lhs: String,
    ...
    pub async fn parse_cmd<D: Deserialize<'static>>(
        &self,
        str: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn create_user_command_wv(
        &self,
        name: String,
        command: Object,
        opts: Dict,
    ...
    pub async fn buf_create_user_command_wv(
        &self,
        buffer: Buffer,
        name: String,
        command: Object,
    ...
    pub async fn get_commands<D: Deserialize<'static>>(
        &self,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn buf_get_commands<D: Deserialize<'static>>(
        &self,
        buffer: Buffer,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn buf_get_extmark_by_id_wv(
        &self,
        buffer: Buffer,
        ns_id: Integer,
        id: Integer,
    ...
    pub async fn buf_get_extmarks<D: Deserialize<'static>>(
        &self,
        buffer: Buffer,
        ns_id: Integer,
    ...
    pub async fn buf_get_extmarks_wv(
        &self,
        buffer: Buffer,
        ns_id: Integer,
        start: Object,
    ...
    pub async fn buf_set_extmark_wv(
        &self,
        buffer: Buffer,
        ns_id: Integer,
        line: Integer,
    ...
    pub async fn set_decoration_provider_wv(
        &self,
        ns_id: Integer,
        opts: Dict,
    ) -> error::Result<()> {
    ...
    pub async fn get_option_value<D: Deserialize<'static>>(
        &self,
        name: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn set_option_value_wv(
        &self,
        name: String,
        value: Object,
        opts: Dict,
    ...
    pub async fn get_option_info2<D: Deserialize<'static>>(
        &self,
        name: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn tabpage_get_var<D: Deserialize<'static>>(
        &self,
        tabpage: Tabpage,
        name: &str,
    ) -> error::Result<D> {
    ...
    pub async fn tabpage_get_var_wv(
        &self,
        tabpage: Tabpage,
        name: String,
    ) -> error::Result<Object> {
    ...
    pub async fn tabpage_set_var_wv(
        &self,
        tabpage: Tabpage,
        name: String,
        value: Object,
    ...
    pub async fn get_hl<D: Deserialize<'static>>(
        &self,
        ns_id: Integer,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn exec_lua<D: Deserialize<'static>>(
        &self,
        code: &str,
        args: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn get_context<D: Deserialize<'static>>(
        &self,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn load_context<D: Deserialize<'static>>(
        &self,
        dict: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn set_client_info_wv(
        &self,
        name: String,
        version: Dict,
        type_: String,
    ...
    pub async fn get_proc_children<D: Deserialize<'static>>(
        &self,
        pid: Integer,
    ) -> error::Result<D> {
    ...
    pub async fn select_popupmenu_item_wv(
        &self,
        item: Integer,
        insert: Boolean,
        finish: Boolean,
    ...
    pub async fn get_mark<D: Deserialize<'static>>(
        &self,
        name: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn eval_statusline<D: Deserialize<'static>>(
        &self,
        str: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn exec2<D: Deserialize<'static>>(
        &self,
        src: &str,
        opts: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn call_function<D: Deserialize<'static>>(
        &self,
        fn_: &str,
        args: impl Serialize,
    ) -> error::Result<D> {
    ...
    pub async fn call_dict_function<D: Deserialize<'static>>(
        &self,
        dict: impl Serialize,
        fn_: &str,
        args: impl Serialize,
    ...
    pub async fn call_dict_function_wv(
        &self,
        dict: Object,
        fn_: String,
        args: Array,
    ...
    pub async fn parse_expression<D: Deserialize<'static>>(
        &self,
        expr: &str,
        flags: &str,
        highlight: Boolean,
    ...
    pub async fn parse_expression_wv(
        &self,
        expr: String,
        flags: String,
        highlight: Boolean,
    ...
    pub async fn win_get_config<D: Deserialize<'static>>(
        &self,
        window: Window,
    ) -> error::Result<D> {
    ...
    pub async fn win_get_var<D: Deserialize<'static>>(
        &self,
        window: Window,
        name: &str,
    ) -> error::Result<D> {
    ...
    pub async fn win_text_height<D: Deserialize<'static>>(
        &self,
        window: Window,
        opts: impl Serialize,
    ) -> error::Result<D> {
