...
}fn buf_attach(&self, buffer: Buffer, send_buffer: Boolean, opts: impl Serialize, ) -> error::Result<()> {
...
}fn buf_get_lines(&self, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, ) -> error::Result<()> {
	self.call_fn("nvim_buf_get_lines".into(), (buffer, start, end, strict_indexing, ))
}fn buf_set_lines(&self, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, replacement: &[&str], ) -> error::Result<()> {
	self.call_fn("nvim_buf_set_lines".into(), (buffer, start, end, strict_indexing, replacement, ))
}fn buf_set_text(&self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, replacement: &[&str], ) -> error::Result<()> {
	self.call_fn("nvim_buf_set_text".into(), (buffer, start_row, start_col, end_row, end_col, replacement, ))
}fn buf_get_text(&self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_get_text".into(), (buffer, start_row, start_col, end_row, end_col, opts, ))
}fn buf_get_text_wv(&self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_buf_get_text".into(), (buffer, start_row, start_col, end_row, end_col, opts, ))
...
}fn buf_set_keymap(&self, buffer: Buffer, mode: &str, lhs: &str, rhs: &str, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_set_keymap".into(), (buffer, mode, lhs, rhs, opts, ))
}fn buf_set_keymap_wv(&self, buffer: Buffer, mode: String, lhs: String, rhs: String, opts: Dict, ) -> error::Result<()> {
...
}fn buf_set_mark(&self, buffer: Buffer, name: &str, line: Integer, col: Integer, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_set_mark".into(), (buffer, name, line, col, opts, ))
}fn buf_set_mark_wv(&self, buffer: Buffer, name: String, line: Integer, col: Integer, opts: Dict, ) -> error::Result<()> {
...
}fn create_user_command(&self, name: &str, command: impl Serialize, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_create_user_command".into(), (name, command, opts, ))
}fn create_user_command_wv(&self, name: String, command: Object, opts: Dict, ) -> error::Result<()> {
...
}fn buf_create_user_command(&self, buffer: Buffer, name: &str, command: impl Serialize, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_create_user_command".into(), (buffer, name, command, opts, ))
}fn buf_create_user_command_wv(&self, buffer: Buffer, name: String, command: Object, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_buf_create_user_command".into(), (buffer, name, command, opts, ))
...
}fn buf_get_extmark_by_id(&self, buffer: Buffer, ns_id: Integer, id: Integer, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_get_extmark_by_id".into(), (buffer, ns_id, id, opts, ))
}fn buf_get_extmark_by_id_wv(&self, buffer: Buffer, ns_id: Integer, id: Integer, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_buf_get_extmark_by_id".into(), (buffer, ns_id, id, opts, ))
}fn buf_get_extmarks(&self, buffer: Buffer, ns_id: Integer, start: impl Serialize, end: impl Serialize, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_get_extmarks".into(), (buffer, ns_id, start, end, opts, ))
}fn buf_get_extmarks_wv(&self, buffer: Buffer, ns_id: Integer, start: Object, end: Object, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_buf_get_extmarks".into(), (buffer, ns_id, start, end, opts, ))
}fn buf_set_extmark(&self, buffer: Buffer, ns_id: Integer, line: Integer, col: Integer, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_buf_set_extmark".into(), (buffer, ns_id, line, col, opts, ))
}fn buf_set_extmark_wv(&self, buffer: Buffer, ns_id: Integer, line: Integer, col: Integer, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_buf_set_extmark".into(), (buffer, ns_id, line, col, opts, ))
...
}fn buf_clear_namespace(&self, buffer: Buffer, ns_id: Integer, line_start: Integer, line_end: Integer, ) -> error::Result<()> {
	self.call_fn("nvim_buf_clear_namespace".into(), (buffer, ns_id, line_start, line_end, ))
...
}fn set_option_value(&self, name: &str, value: impl Serialize, opts: impl Serialize, ) -> error::Result<()> {
...
}fn tabpage_set_var(&self, tabpage: Tabpage, name: &str, value: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_tabpage_set_var".into(), (tabpage, name, value, ))
}fn tabpage_set_var_wv(&self, tabpage: Tabpage, name: String, value: Object, ) -> error::Result<()> {
...
}fn ui_attach(&self, width: Integer, height: Integer, options: impl Serialize, ) -> error::Result<()> {
...
}fn ui_try_resize_grid(&self, grid: Integer, width: Integer, height: Integer, ) -> error::Result<()> {
...
}fn ui_pum_set_bounds(&self, width: Float, height: Float, row: Float, col: Float, ) -> error::Result<()> {
...
}fn input_mouse(&self, button: &str, action: &str, modifier: &str, grid: Integer, row: Integer, col: Integer, ) -> error::Result<()> {
	self.call_fn("nvim_input_mouse".into(), (button, action, modifier, grid, row, col, ))
}fn replace_termcodes(&self, str: &str, from_part: Boolean, do_lt: Boolean, special: Boolean, ) -> error::Result<()> {
	self.call_fn("nvim_replace_termcodes".into(), (str, from_part, do_lt, special, ))
...
}fn echo(&self, chunks: impl Serialize, history: Boolean, opts: impl Serialize, ) -> error::Result<()> {
...
}fn put(&self, lines: &[&str], type_: &str, after: Boolean, follow: Boolean, ) -> error::Result<()> {
...
}fn set_keymap(&self, mode: &str, lhs: &str, rhs: &str, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_set_keymap".into(), (mode, lhs, rhs, opts, ))
}fn set_keymap_wv(&self, mode: String, lhs: String, rhs: String, opts: Dict, ) -> error::Result<()> {
...
}fn set_client_info(&self, name: &str, version: impl Serialize, type_: &str, methods: impl Serialize, attributes: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_set_client_info".into(), (name, version, type_, methods, attributes, ))
}fn set_client_info_wv(&self, name: String, version: Dict, type_: String, methods: Dict, attributes: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_set_client_info".into(), (name, version, type_, methods, attributes, ))
...
}fn select_popupmenu_item(&self, item: Integer, insert: Boolean, finish: Boolean, opts: impl Serialize, ) -> error::Result<()> {
	self.call_fn("nvim_select_popupmenu_item".into(), (item, insert, finish, opts, ))
}fn select_popupmenu_item_wv(&self, item: Integer, insert: Boolean, finish: Boolean, opts: Dict, ) -> error::Result<()> {
	self.call_fn_wv("nvim_select_popupmenu_item".into(), (item, insert, finish, opts, ))
...
}fn call_dict_function(&self, dict: impl Serialize, fn_: &str, args: impl Serialize, ) -> error::Result<()> {
...
}fn open_win(&self, buffer: Buffer, enter: Boolean, config: impl Serialize, ) -> error::Result<()> {
