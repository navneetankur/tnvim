...
///
///==============================================================================
pub async fn get_autocmds(&mut self, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_autocmds", (opts, )).await
}
///nvim_get_autocmds({opts})                                *nvim_get_autocmds()*
///    Get all autocommands that match the corresponding {opts}.
///
...
///
///==============================================================================
pub async fn get_autocmds_wv(&mut self, opts: Dict, ) -> Array {
	self.call_fn_wv("nvim_get_autocmds", (opts, )).await
}
...
pub async fn create_autocmd(&mut self, event: impl Serialize, opts: impl Serialize, ) -> Integer {
	self.call_fn("nvim_create_autocmd", (event, opts, )).await
}
///nvim_create_autocmd({event}, {opts})                   *nvim_create_autocmd()*
///    Creates an |autocommand| event handler, defined by `callback` (Lua
///    function or Vimscript function name string) or `command` (Ex command
...
///                   value (not `false` or `nil`) to delete the autocommand, and
///                   receives one argument, a table with these keys:
pub async fn create_autocmd_wv(&mut self, event: Object, opts: Dict, ) -> Integer {
	self.call_fn_wv("nvim_create_autocmd", (event, opts, )).await
}
...
///
pub async fn del_autocmd(&mut self, id: Integer, ) -> () {
	self.call_fn("nvim_del_autocmd", (id, )).await
}
...
///                    group.
///
pub async fn clear_autocmds(&mut self, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_clear_autocmds", (opts, )).await
}
///nvim_clear_autocmds({opts})                            *nvim_clear_autocmds()*
///    Clears all autocommands selected by {opts}. To delete autocmds see
///    |nvim_del_autocmd()|.
...
///                    group.
///
pub async fn clear_autocmds_wv(&mut self, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_clear_autocmds", (opts, )).await
}
...
///      • |autocmd-groups|
///
pub async fn create_augroup(&mut self, name: &str, opts: impl Serialize, ) -> Integer {
	self.call_fn("nvim_create_augroup", (name, opts, )).await
}
///nvim_create_augroup({name}, {opts})                    *nvim_create_augroup()*
///    Create or get an autocommand group |autocmd-groups|.
///
...
///      • |autocmd-groups|
///
pub async fn create_augroup_wv(&mut self, name: String, opts: Dict, ) -> Integer {
	self.call_fn_wv("nvim_create_augroup", (name, opts, )).await
}
...
///      • |nvim_create_augroup()|
///
pub async fn del_augroup_by_id(&mut self, id: Integer, ) -> () {
	self.call_fn("nvim_del_augroup_by_id", (id, )).await
}
...
///      • |autocmd-groups|
///
pub async fn del_augroup_by_name(&mut self, name: &str, ) -> () {
	self.call_fn("nvim_del_augroup_by_name", (name, )).await
}
...
///      • |:doautocmd|
///
pub async fn exec_autocmds(&mut self, event: impl Serialize, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_exec_autocmds", (event, opts, )).await
}
///nvim_exec_autocmds({event}, {opts})                     *nvim_exec_autocmds()*
///    Execute all autocommands for {event} that match the corresponding {opts}
///    |autocmd-execute|.
...
///      • |:doautocmd|
///
pub async fn exec_autocmds_wv(&mut self, event: Object, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_exec_autocmds", (event, opts, )).await
}
...
///
pub async fn buf_line_count(&mut self, buffer: Buffer, ) -> Integer {
	self.call_fn("nvim_buf_line_count", (buffer, )).await
}
...
///
pub async fn buf_attach(&mut self, buffer: Buffer, send_buffer: Boolean, opts: impl Serialize, ) -> Boolean {
	self.call_fn("nvim_buf_attach", (buffer, send_buffer, opts, )).await
}
///nvim_buf_attach({buffer}, {send_buffer}, {opts})           *nvim_buf_attach()*
///    Activates buffer-update events on a channel, or as Lua callbacks.
///
...
///      • |api-buffer-updates-lua|
///
pub async fn buf_attach_wv(&mut self, buffer: Buffer, send_buffer: Boolean, opts: Dict, ) -> Boolean {
	self.call_fn_wv("nvim_buf_attach", (buffer, send_buffer, opts, )).await
}
...
///
pub async fn buf_detach(&mut self, buffer: Buffer, ) -> Boolean {
	self.call_fn("nvim_buf_detach", (buffer, )).await
}
///                                                        *nvim_buf_get_lines()*
...
///      • |nvim_buf_get_text()|
///
pub async fn buf_get_lines(&mut self, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, ) -> Vec<String> {
	self.call_fn("nvim_buf_get_lines", (buffer, start, end, strict_indexing, )).await
}
///                                                        *nvim_buf_set_lines()*
...
///      • |nvim_buf_set_text()|
///
pub async fn buf_set_lines(&mut self, buffer: Buffer, start: Integer, end: Integer, strict_indexing: Boolean, replacement: &[&str], ) -> () {
	self.call_fn("nvim_buf_set_lines", (buffer, start, end, strict_indexing, replacement, )).await
}
///                                                         *nvim_buf_set_text()*
...
///      • {replacement}  Array of lines to use as replacement
///
pub async fn buf_set_text(&mut self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, replacement: &[&str], ) -> () {
	self.call_fn("nvim_buf_set_text", (buffer, start_row, start_col, end_row, end_col, replacement, )).await
}
///                                                         *nvim_buf_get_text()*
...
///        Array of lines, or empty array for unloaded buffer.
///
pub async fn buf_get_text(&mut self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, opts: impl Serialize, ) -> Vec<String> {
	self.call_fn("nvim_buf_get_text", (buffer, start_row, start_col, end_row, end_col, opts, )).await
}
///                                                         *nvim_buf_get_text()*
///nvim_buf_get_text({buffer}, {start_row}, {start_col}, {end_row}, {end_col},
///                  {opts})
...
///        Array of lines, or empty array for unloaded buffer.
///
pub async fn buf_get_text_wv(&mut self, buffer: Buffer, start_row: Integer, start_col: Integer, end_row: Integer, end_col: Integer, opts: Dict, ) -> Vec<String> {
	self.call_fn_wv("nvim_buf_get_text", (buffer, start_row, start_col, end_row, end_col, opts, )).await
}
...
///
pub async fn buf_get_offset(&mut self, buffer: Buffer, index: Integer, ) -> Integer {
	self.call_fn("nvim_buf_get_offset", (buffer, index, )).await
}
...
///        Variable value
///
pub async fn buf_get_var(&mut self, buffer: Buffer, name: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_buf_get_var", (buffer, name, )).await
}
///nvim_buf_get_var({buffer}, {name})                        *nvim_buf_get_var()*
///    Gets a buffer-scoped (b:) variable.
///
...
///        Variable value
///
pub async fn buf_get_var_wv(&mut self, buffer: Buffer, name: String, ) -> Object {
	self.call_fn_wv("nvim_buf_get_var", (buffer, name, )).await
}
...
///        `b:changedtick` value.
///
pub async fn buf_get_changedtick(&mut self, buffer: Buffer, ) -> Integer {
	self.call_fn("nvim_buf_get_changedtick", (buffer, )).await
}
...
///
pub async fn buf_get_keymap(&mut self, buffer: Buffer, mode: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_buf_get_keymap", (buffer, mode, )).await
}
///nvim_buf_get_keymap({buffer}, {mode})                  *nvim_buf_get_keymap()*
///    Gets a list of buffer-local |mapping| definitions.
///
...
///        "buffer" key holds the associated buffer id.
///
pub async fn buf_get_keymap_wv(&mut self, buffer: Buffer, mode: String, ) -> Vec<Dict> {
	self.call_fn_wv("nvim_buf_get_keymap", (buffer, mode, )).await
}
///                                                       *nvim_buf_set_keymap()*
...
///      • |nvim_set_keymap()|
///
pub async fn buf_set_keymap(&mut self, buffer: Buffer, mode: &str, lhs: &str, rhs: &str, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_buf_set_keymap", (buffer, mode, lhs, rhs, opts, )).await
}
///                                                       *nvim_buf_set_keymap()*
///nvim_buf_set_keymap({buffer}, {mode}, {lhs}, {rhs}, {opts})
///    Sets a buffer-local |mapping| for the given mode.
...
///      • |nvim_set_keymap()|
///
pub async fn buf_set_keymap_wv(&mut self, buffer: Buffer, mode: String, lhs: String, rhs: String, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_buf_set_keymap", (buffer, mode, lhs, rhs, opts, )).await
}
...
///      • |nvim_del_keymap()|
///
pub async fn buf_del_keymap(&mut self, buffer: Buffer, mode: &str, lhs: &str, ) -> () {
	self.call_fn("nvim_buf_del_keymap", (buffer, mode, lhs, )).await
}
...
///
///==============================================================================
pub async fn buf_set_var(&mut self, buffer: Buffer, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_buf_set_var", (buffer, name, value, )).await
}
///nvim_buf_set_var({buffer}, {name}, {value})               *nvim_buf_set_var()*
///    Sets a buffer-scoped (b:) variable
///
...
///
///==============================================================================
pub async fn buf_set_var_wv(&mut self, buffer: Buffer, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_buf_set_var", (buffer, name, value, )).await
}
...
///      • {name}    Variable name
///
pub async fn buf_del_var(&mut self, buffer: Buffer, name: &str, ) -> () {
	self.call_fn("nvim_buf_del_var", (buffer, name, )).await
}
...
///        Buffer name
///
pub async fn buf_get_name(&mut self, buffer: Buffer, ) -> String {
	self.call_fn("nvim_buf_get_name", (buffer, )).await
}
...
///      • {name}    Buffer name
///
pub async fn buf_set_name(&mut self, buffer: Buffer, name: &str, ) -> () {
	self.call_fn("nvim_buf_set_name", (buffer, name, )).await
}
...
///
pub async fn buf_is_loaded(&mut self, buffer: Buffer, ) -> Boolean {
	self.call_fn("nvim_buf_is_loaded", (buffer, )).await
}
...
///
pub async fn buf_delete(&mut self, buffer: Buffer, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_buf_delete", (buffer, opts, )).await
}
///nvim_buf_delete({buffer}, {opts})                          *nvim_buf_delete()*
///    Deletes the buffer. See |:bwipeout|
///
...
///                  • unload: Unloaded only, do not delete. See |:bunload|
///
pub async fn buf_delete_wv(&mut self, buffer: Buffer, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_buf_delete", (buffer, opts, )).await
}
...
///
pub async fn buf_is_valid(&mut self, buffer: Buffer, ) -> Boolean {
	self.call_fn("nvim_buf_is_valid", (buffer, )).await
}
...
///      • |nvim_del_mark()|
///
pub async fn buf_del_mark(&mut self, buffer: Buffer, name: &str, ) -> Boolean {
	self.call_fn("nvim_buf_del_mark", (buffer, name, )).await
}
///                                                         *nvim_buf_set_mark()*
...
///      • |nvim_buf_get_mark()|
///
pub async fn buf_set_mark(&mut self, buffer: Buffer, name: &str, line: Integer, col: Integer, opts: impl Serialize, ) -> Boolean {
	self.call_fn("nvim_buf_set_mark", (buffer, name, line, col, opts, )).await
}
///                                                         *nvim_buf_set_mark()*
///nvim_buf_set_mark({buffer}, {name}, {line}, {col}, {opts})
///    Sets a named mark in the given buffer, all marks are allowed
...
///      • |nvim_buf_get_mark()|
///
pub async fn buf_set_mark_wv(&mut self, buffer: Buffer, name: String, line: Integer, col: Integer, opts: Dict, ) -> Boolean {
	self.call_fn_wv("nvim_buf_set_mark", (buffer, name, line, col, opts, )).await
}
...
///      • |nvim_buf_del_mark()|
///
pub async fn buf_get_mark(&mut self, buffer: Buffer, name: &str, ) -> Vec<Integer> {
	self.call_fn("nvim_buf_get_mark", (buffer, name, )).await
}
...
///
///==============================================================================
pub async fn parse_cmd(&mut self, str: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_parse_cmd", (str, opts, )).await
}
///nvim_parse_cmd({str}, {opts})                               *nvim_parse_cmd()*
///    Parse command line.
///
...
///
///==============================================================================
pub async fn parse_cmd_wv(&mut self, str: String, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_parse_cmd", (str, opts, )).await
}
...
///      • |nvim_command()|
///
pub async fn cmd(&mut self, cmd: impl Serialize, opts: impl Serialize, ) -> String {
	self.call_fn("nvim_cmd", (cmd, opts, )).await
}
///nvim_cmd({cmd}, {opts})                                           *nvim_cmd()*
///    Executes an Ex command.
///
...
///      • |nvim_command()|
///
pub async fn cmd_wv(&mut self, cmd: Dict, opts: Dict, ) -> String {
	self.call_fn_wv("nvim_cmd", (cmd, opts, )).await
}
...
///                       |:command-preview|
///
pub async fn create_user_command(&mut self, name: &str, command: impl Serialize, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_create_user_command", (name, command, opts, )).await
}
///                                                  *nvim_create_user_command()*
///nvim_create_user_command({name}, {command}, {opts})
///    Creates a global |user-commands| command.
...
///                       |:command-preview|
///
pub async fn create_user_command_wv(&mut self, name: String, command: Object, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_create_user_command", (name, command, opts, )).await
}
...
///
pub async fn del_user_command(&mut self, name: &str, ) -> () {
	self.call_fn("nvim_del_user_command", (name, )).await
}
...
///      • nvim_create_user_command
///
pub async fn buf_create_user_command(&mut self, buffer: Buffer, name: &str, command: impl Serialize, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_buf_create_user_command", (buffer, name, command, opts, )).await
}
///                                              *nvim_buf_create_user_command()*
///nvim_buf_create_user_command({buffer}, {name}, {command}, {opts})
///    Creates a buffer-local command |user-commands|.
...
///      • nvim_create_user_command
///
pub async fn buf_create_user_command_wv(&mut self, buffer: Buffer, name: String, command: Object, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_buf_create_user_command", (buffer, name, command, opts, )).await
}
...
///      • {name}    Name of the command to delete.
///
pub async fn buf_del_user_command(&mut self, buffer: Buffer, name: &str, ) -> () {
	self.call_fn("nvim_buf_del_user_command", (buffer, name, )).await
}
...
///
pub async fn get_commands(&mut self, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_commands", (opts, )).await
}
///nvim_get_commands({opts})                                *nvim_get_commands()*
///    Gets a map of global (non-buffer-local) Ex commands.
///
...
///      • |nvim_get_all_options_info()|
///
pub async fn get_commands_wv(&mut self, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_get_commands", (opts, )).await
}
...
///        Map of maps describing commands.
///
pub async fn buf_get_commands(&mut self, buffer: Buffer, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_buf_get_commands", (buffer, opts, )).await
}
///nvim_buf_get_commands({buffer}, {opts})              *nvim_buf_get_commands()*
///    Gets a map of buffer-local |user-commands|.
///
...
///        Map of maps describing commands.
///
pub async fn buf_get_commands_wv(&mut self, buffer: Buffer, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_buf_get_commands", (buffer, opts, )).await
}
///nvim_create_namespace({name})                        *nvim_create_namespace()*
pub async fn create_namespace(&mut self, name: &str, ) -> Integer {
	self.call_fn("nvim_create_namespace", (name, )).await
}
...
///
pub async fn get_namespaces(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_namespaces", [();0]).await
}
///nvim_get_namespaces()                                  *nvim_get_namespaces()*
///    Gets existing, non-anonymous |namespace|s.
///
...
///        dict that maps from names to namespace ids.
///
pub async fn get_namespaces_wv(&mut self, ) -> Dict {
	self.call_fn_wv("nvim_get_namespaces", [();0]).await
}
...
///
pub async fn buf_get_extmark_by_id(&mut self, buffer: Buffer, ns_id: Integer, id: Integer, opts: impl Serialize, ) -> Vec<Integer> {
	self.call_fn("nvim_buf_get_extmark_by_id", (buffer, ns_id, id, opts, )).await
}
///                                                *nvim_buf_get_extmark_by_id()*
///nvim_buf_get_extmark_by_id({buffer}, {ns_id}, {id}, {opts})
///    Gets the position (0-indexed) of an |extmark|.
...
///        0-indexed (row, col) tuple or empty list () if extmark id was absent
///
pub async fn buf_get_extmark_by_id_wv(&mut self, buffer: Buffer, ns_id: Integer, id: Integer, opts: Dict, ) -> Vec<Integer> {
	self.call_fn_wv("nvim_buf_get_extmark_by_id", (buffer, ns_id, id, opts, )).await
}
...
///
pub async fn buf_get_extmarks(&mut self, buffer: Buffer, ns_id: Integer, start: impl Serialize, end: impl Serialize, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_buf_get_extmarks", (buffer, ns_id, start, end, opts, )).await
}
///                                                     *nvim_buf_get_extmarks()*
///nvim_buf_get_extmarks({buffer}, {ns_id}, {start}, {end}, {opts})
///    Gets |extmarks| in "traversal order" from a |charwise| region defined by
...
///        List of `[extmark_id, row, col]` tuples in "traversal order".
///
pub async fn buf_get_extmarks_wv(&mut self, buffer: Buffer, ns_id: Integer, start: Object, end: Object, opts: Dict, ) -> Array {
	self.call_fn_wv("nvim_buf_get_extmarks", (buffer, ns_id, start, end, opts, )).await
}
...
///
pub async fn buf_set_extmark(&mut self, buffer: Buffer, ns_id: Integer, line: Integer, col: Integer, opts: impl Serialize, ) -> Integer {
	self.call_fn("nvim_buf_set_extmark", (buffer, ns_id, line, col, opts, )).await
}
///                                                      *nvim_buf_set_extmark()*
///nvim_buf_set_extmark({buffer}, {ns_id}, {line}, {col}, {opts})
///    Creates or updates an |extmark|.
...
///        Id of the created/updated extmark
///
pub async fn buf_set_extmark_wv(&mut self, buffer: Buffer, ns_id: Integer, line: Integer, col: Integer, opts: Dict, ) -> Integer {
	self.call_fn_wv("nvim_buf_set_extmark", (buffer, ns_id, line, col, opts, )).await
}
...
///
pub async fn buf_del_extmark(&mut self, buffer: Buffer, ns_id: Integer, id: Integer, ) -> Boolean {
	self.call_fn("nvim_buf_del_extmark", (buffer, ns_id, id, )).await
}
...
///
pub async fn buf_clear_namespace(&mut self, buffer: Buffer, ns_id: Integer, line_start: Integer, line_end: Integer, ) -> () {
	self.call_fn("nvim_buf_clear_namespace", (buffer, ns_id, line_start, line_end, )).await
}
...
///<
///
pub async fn set_decoration_provider(&mut self, ns_id: Integer, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_set_decoration_provider", (ns_id, opts, )).await
}
///                                              *nvim_set_decoration_provider()*
///nvim_set_decoration_provider({ns_id}, {opts})
///    Set or change decoration provider for a |namespace|
...
///<
///
pub async fn set_decoration_provider_wv(&mut self, ns_id: Integer, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_set_decoration_provider", (ns_id, opts, )).await
}
...
///        Option value
///
pub async fn get_option_value(&mut self, name: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_option_value", (name, opts, )).await
}
///nvim_get_option_value({name}, {opts})                *nvim_get_option_value()*
///    Gets the value of an option. The behavior of this function matches that of
///    |:set|: the local value of an option is returned if it exists; otherwise,
...
///        Option value
///
pub async fn get_option_value_wv(&mut self, name: String, opts: Dict, ) -> Object {
	self.call_fn_wv("nvim_get_option_value", (name, opts, )).await
}
...
///
///==============================================================================
pub async fn set_option_value(&mut self, name: &str, value: impl Serialize, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_set_option_value", (name, value, opts, )).await
}
///                                                     *nvim_set_option_value()*
///nvim_set_option_value({name}, {value}, {opts})
///    Sets the value of an option. The behavior of this function matches that of
...
///
///==============================================================================
pub async fn set_option_value_wv(&mut self, name: String, value: Object, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_set_option_value", (name, value, opts, )).await
}
...
///      • |nvim_get_commands()|
///
pub async fn get_all_options_info(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_all_options_info", [();0]).await
}
///nvim_get_all_options_info()                      *nvim_get_all_options_info()*
///    Gets the option information for all options.
///
...
///      • |nvim_get_commands()|
///
pub async fn get_all_options_info_wv(&mut self, ) -> Dict {
	self.call_fn_wv("nvim_get_all_options_info", [();0]).await
}
...
///        Option Information
///
pub async fn get_option_info2(&mut self, name: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_option_info2", (name, opts, )).await
}
///nvim_get_option_info2({name}, {opts})                *nvim_get_option_info2()*
///    Gets the option information for one option from arbitrary buffer or window
///
...
///        Option Information
///
pub async fn get_option_info2_wv(&mut self, name: String, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_get_option_info2", (name, opts, )).await
}
...
///
pub async fn tabpage_list_wins(&mut self, tabpage: Tabpage, ) -> Vec<Window> {
	self.call_fn("nvim_tabpage_list_wins", (tabpage, )).await
}
...
///        Variable value
///
pub async fn tabpage_get_var(&mut self, tabpage: Tabpage, name: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_tabpage_get_var", (tabpage, name, )).await
}
///nvim_tabpage_get_var({tabpage}, {name})               *nvim_tabpage_get_var()*
///    Gets a tab-scoped (t:) variable
///
...
///        Variable value
///
pub async fn tabpage_get_var_wv(&mut self, tabpage: Tabpage, name: String, ) -> Object {
	self.call_fn_wv("nvim_tabpage_get_var", (tabpage, name, )).await
}
...
///      • {value}    Variable value
///
pub async fn tabpage_set_var(&mut self, tabpage: Tabpage, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_tabpage_set_var", (tabpage, name, value, )).await
}
///                                                      *nvim_tabpage_set_var()*
///nvim_tabpage_set_var({tabpage}, {name}, {value})
///    Sets a tab-scoped (t:) variable
...
///      • {value}    Variable value
///
pub async fn tabpage_set_var_wv(&mut self, tabpage: Tabpage, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_tabpage_set_var", (tabpage, name, value, )).await
}
...
///      • {name}     Variable name
///
pub async fn tabpage_del_var(&mut self, tabpage: Tabpage, name: &str, ) -> () {
	self.call_fn("nvim_tabpage_del_var", (tabpage, name, )).await
}
...
///        |window-ID|
///
pub async fn tabpage_get_win(&mut self, tabpage: Tabpage, ) -> Window {
	self.call_fn("nvim_tabpage_get_win", (tabpage, )).await
}
...
///
///==============================================================================
pub async fn tabpage_set_win(&mut self, tabpage: Tabpage, win: Window, ) -> () {
	self.call_fn("nvim_tabpage_set_win", (tabpage, win, )).await
}
...
///        Tabpage number
///
pub async fn tabpage_get_number(&mut self, tabpage: Tabpage, ) -> Integer {
	self.call_fn("nvim_tabpage_get_number", (tabpage, )).await
}
...
///
pub async fn tabpage_is_valid(&mut self, tabpage: Tabpage, ) -> Boolean {
	self.call_fn("nvim_tabpage_is_valid", (tabpage, )).await
}
...
///
pub async fn ui_attach(&mut self, width: Integer, height: Integer, options: impl Serialize, ) -> () {
	self.call_fn("nvim_ui_attach", (width, height, options, )).await
}
///nvim_ui_attach({width}, {height}, {options})                *nvim_ui_attach()*
///    Activates UI events on the channel.
///
...
///      • {options}  |ui-option| map
///
pub async fn ui_attach_wv(&mut self, width: Integer, height: Integer, options: Dict, ) -> () {
	self.call_fn_wv("nvim_ui_attach", (width, height, options, )).await
}
...
///        Since: 0.9.0
///
pub async fn ui_set_focus(&mut self, gained: Boolean, ) -> () {
	self.call_fn("nvim_ui_set_focus", (gained, )).await
}
...
///        Since: 0.1.0
///
pub async fn ui_detach(&mut self, ) -> () {
	self.call_fn("nvim_ui_detach", [();0]).await
}
...
///        Since: 0.1.0
///
pub async fn ui_try_resize(&mut self, width: Integer, height: Integer, ) -> () {
	self.call_fn("nvim_ui_try_resize", (width, height, )).await
}
...
///        Since: 0.1.0
///
pub async fn ui_set_option(&mut self, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_ui_set_option", (name, value, )).await
}
///nvim_ui_set_option({name}, {value})                     *nvim_ui_set_option()*
///
///    Attributes: ~
...
///        Since: 0.1.0
///
pub async fn ui_set_option_wv(&mut self, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_ui_set_option", (name, value, )).await
}
...
///
pub async fn ui_try_resize_grid(&mut self, grid: Integer, width: Integer, height: Integer, ) -> () {
	self.call_fn("nvim_ui_try_resize_grid", (grid, width, height, )).await
}
...
///
pub async fn ui_pum_set_height(&mut self, height: Integer, ) -> () {
	self.call_fn("nvim_ui_pum_set_height", (height, )).await
}
...
///
pub async fn ui_pum_set_bounds(&mut self, width: Float, height: Float, row: Float, col: Float, ) -> () {
	self.call_fn("nvim_ui_pum_set_bounds", (width, height, row, col, )).await
}
...
///      • {value}  Event payload
///
pub async fn ui_term_event(&mut self, event: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_ui_term_event", (event, value, )).await
}
///nvim_ui_term_event({event}, {value})                    *nvim_ui_term_event()*
///    Tells Nvim when a terminal event has occurred
///
...
///      • {value}  Event payload
///
pub async fn ui_term_event_wv(&mut self, event: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_ui_term_event", (event, value, )).await
}
...
///        Since: 0.5.0
///
pub async fn get_hl_id_by_name(&mut self, name: &str, ) -> Integer {
	self.call_fn("nvim_get_hl_id_by_name", (name, )).await
}
...
///
pub async fn get_hl(&mut self, ns_id: Integer, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_hl", (ns_id, opts, )).await
}
///nvim_get_hl({ns_id}, {opts})                                   *nvim_get_hl()*
///    Gets all or specific highlight groups in a namespace.
///
...
///        if requested by name or id.
///
pub async fn get_hl_wv(&mut self, ns_id: Integer, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_get_hl", (ns_id, opts, )).await
}
...
///                   exists.
///
pub async fn set_hl(&mut self, ns_id: Integer, name: &str, val: impl Serialize, ) -> () {
	self.call_fn("nvim_set_hl", (ns_id, name, val, )).await
}
///nvim_set_hl({ns_id}, {name}, {val})                            *nvim_set_hl()*
///    Sets a highlight group.
///
...
///                   exists.
///
pub async fn set_hl_wv(&mut self, ns_id: Integer, name: String, val: Dict, ) -> () {
	self.call_fn_wv("nvim_set_hl", (ns_id, name, val, )).await
}
...
///        Namespace id, or -1
///
pub async fn get_hl_ns(&mut self, opts: impl Serialize, ) -> Integer {
	self.call_fn("nvim_get_hl_ns", (opts, )).await
}
///nvim_get_hl_ns({opts})                                      *nvim_get_hl_ns()*
///    Gets the active highlight namespace.
///
...
///        Namespace id, or -1
///
pub async fn get_hl_ns_wv(&mut self, opts: Dict, ) -> Integer {
	self.call_fn_wv("nvim_get_hl_ns", (opts, )).await
}
...
///
pub async fn set_hl_ns(&mut self, ns_id: Integer, ) -> () {
	self.call_fn("nvim_set_hl_ns", (ns_id, )).await
}
...
///
pub async fn set_hl_ns_fast(&mut self, ns_id: Integer, ) -> () {
	self.call_fn("nvim_set_hl_ns_fast", (ns_id, )).await
}
...
///
pub async fn feedkeys(&mut self, keys: &str, mode: &str, escape_ks: Boolean, ) -> () {
	self.call_fn("nvim_feedkeys", (keys, mode, escape_ks, )).await
}
...
///        buffer becomes full).
///
pub async fn input(&mut self, keys: &str, ) -> Integer {
	self.call_fn("nvim_input", (keys, )).await
}
///                                                          *nvim_input_mouse()*
...
///
pub async fn input_mouse(&mut self, button: &str, action: &str, modifier: &str, grid: Integer, row: Integer, col: Integer, ) -> () {
	self.call_fn("nvim_input_mouse", (button, action, modifier, grid, row, col, )).await
}
...
///      • cpoptions
///
pub async fn replace_termcodes(&mut self, str: &str, from_part: Boolean, do_lt: Boolean, special: Boolean, ) -> String {
	self.call_fn("nvim_replace_termcodes", (str, from_part, do_lt, special, )).await
}
...
///
pub async fn exec_lua(&mut self, code: &str, args: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_exec_lua", (code, args, )).await
}
///nvim_exec_lua({code}, {args})                                *nvim_exec_lua()*
///    Execute Lua code. Parameters (if any) are available as `...` inside the
///    chunk. The chunk can return a value.
...
///        Return value of Lua code if present or NIL.
///
pub async fn exec_lua_wv(&mut self, code: String, args: Array, ) -> Object {
	self.call_fn_wv("nvim_exec_lua", (code, args, )).await
}
...
///        Number of cells
///
pub async fn strwidth(&mut self, text: &str, ) -> Integer {
	self.call_fn("nvim_strwidth", (text, )).await
}
...
///        List of paths
///
pub async fn list_runtime_paths(&mut self, ) -> Vec<String> {
	self.call_fn("nvim_list_runtime_paths", [();0]).await
}
...
///
pub async fn get_runtime_file(&mut self, name: &str, all: Boolean, ) -> Vec<String> {
	self.call_fn("nvim_get_runtime_file", (name, all, )).await
}
...
///      • {dir}  Directory path
///
pub async fn set_current_dir(&mut self, dir: &str, ) -> () {
	self.call_fn("nvim_set_current_dir", (dir, )).await
}
...
///        Current line string
///
pub async fn get_current_line(&mut self, ) -> String {
	self.call_fn("nvim_get_current_line", [();0]).await
}
...
///      • {line}  Line contents
///
pub async fn set_current_line(&mut self, line: &str, ) -> () {
	self.call_fn("nvim_set_current_line", (line, )).await
}
...
///        Since: 0.1.0
///
pub async fn del_current_line(&mut self, ) -> () {
	self.call_fn("nvim_del_current_line", [();0]).await
}
...
///        Variable value
///
pub async fn get_var(&mut self, name: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_var", (name, )).await
}
///nvim_get_var({name})                                          *nvim_get_var()*
///    Gets a global (g:) variable.
///
...
///        Variable value
///
pub async fn get_var_wv(&mut self, name: String, ) -> Object {
	self.call_fn_wv("nvim_get_var", (name, )).await
}
...
///      • {value}  Variable value
///
pub async fn set_var(&mut self, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_set_var", (name, value, )).await
}
///nvim_set_var({name}, {value})                                 *nvim_set_var()*
///    Sets a global (g:) variable.
///
...
///      • {value}  Variable value
///
pub async fn set_var_wv(&mut self, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_set_var", (name, value, )).await
}
...
///      • {name}  Variable name
///
pub async fn del_var(&mut self, name: &str, ) -> () {
	self.call_fn("nvim_del_var", (name, )).await
}
...
///        Variable value
///
pub async fn get_vvar(&mut self, name: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_vvar", (name, )).await
}
///nvim_get_vvar({name})                                        *nvim_get_vvar()*
///    Gets a v: variable.
///
...
///        Variable value
///
pub async fn get_vvar_wv(&mut self, name: String, ) -> Object {
	self.call_fn_wv("nvim_get_vvar", (name, )).await
}
...
///      • {value}  Variable value
///
pub async fn set_vvar(&mut self, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_set_vvar", (name, value, )).await
}
///nvim_set_vvar({name}, {value})                               *nvim_set_vvar()*
///    Sets a v: variable, if it is not readonly.
///
...
///      • {value}  Variable value
///
pub async fn set_vvar_wv(&mut self, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_set_vvar", (name, value, )).await
}
...
///
pub async fn echo(&mut self, chunks: impl Serialize, history: Boolean, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_echo", (chunks, history, opts, )).await
}
///nvim_echo({chunks}, {history}, {opts})                           *nvim_echo()*
///    Prints a message given by a list of `[text, hl_group]` "chunks".
///
...
///                     "log" file instead of standard output.
///
pub async fn echo_wv(&mut self, chunks: Array, history: Boolean, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_echo", (chunks, history, opts, )).await
}
...
///        List of buffer ids
///
pub async fn list_bufs(&mut self, ) -> Vec<Buffer> {
	self.call_fn("nvim_list_bufs", [();0]).await
}
...
///        Buffer id
///
pub async fn get_current_buf(&mut self, ) -> Buffer {
	self.call_fn("nvim_get_current_buf", [();0]).await
}
...
///      • {buffer}  Buffer id
///
pub async fn set_current_buf(&mut self, buffer: Buffer, ) -> () {
	self.call_fn("nvim_set_current_buf", (buffer, )).await
}
...
///        List of |window-ID|s
///
pub async fn list_wins(&mut self, ) -> Vec<Window> {
	self.call_fn("nvim_list_wins", [();0]).await
}
...
///        |window-ID|
///
pub async fn get_current_win(&mut self, ) -> Window {
	self.call_fn("nvim_get_current_win", [();0]).await
}
...
///
pub async fn set_current_win(&mut self, window: Window, ) -> () {
	self.call_fn("nvim_set_current_win", (window, )).await
}
...
///      • buf_open_scratch
///
pub async fn create_buf(&mut self, listed: Boolean, scratch: Boolean, ) -> Buffer {
	self.call_fn("nvim_create_buf", (listed, scratch, )).await
}
...
///
pub async fn open_term(&mut self, buffer: Buffer, opts: impl Serialize, ) -> Integer {
	self.call_fn("nvim_open_term", (buffer, opts, )).await
}
///nvim_open_term({buffer}, {opts})                            *nvim_open_term()*
///    Open a terminal instance in a buffer
///
...
///        Channel id, or 0 on error
///
pub async fn open_term_wv(&mut self, buffer: Buffer, opts: Dict, ) -> Integer {
	self.call_fn_wv("nvim_open_term", (buffer, opts, )).await
}
...
///
pub async fn chan_send(&mut self, chan: Integer, data: &str, ) -> () {
	self.call_fn("nvim_chan_send", (chan, data, )).await
}
...
///        List of |tab-ID|s
///
pub async fn list_tabpages(&mut self, ) -> Vec<Tabpage> {
	self.call_fn("nvim_list_tabpages", [();0]).await
}
...
///        |tab-ID|
///
pub async fn get_current_tabpage(&mut self, ) -> Tabpage {
	self.call_fn("nvim_get_current_tabpage", [();0]).await
}
...
///
pub async fn set_current_tabpage(&mut self, tabpage: Tabpage, ) -> () {
	self.call_fn("nvim_set_current_tabpage", (tabpage, )).await
}
...
///
pub async fn paste(&mut self, data: &str, crlf: Boolean, phase: Integer, ) -> Boolean {
	self.call_fn("nvim_paste", (data, crlf, phase, )).await
}
...
///
pub async fn put(&mut self, lines: &[&str], type: &str, after: Boolean, follow: Boolean, ) -> () {
	self.call_fn("nvim_put", (lines, type, after, follow, )).await
}
...
///
pub async fn get_color_by_name(&mut self, name: &str, ) -> Integer {
	self.call_fn("nvim_get_color_by_name", (name, )).await
}
...
///
pub async fn get_color_map(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_color_map", [();0]).await
}
///nvim_get_color_map()                                    *nvim_get_color_map()*
///    Returns a map of color names and RGB values.
///
...
///        Map of color names and RGB values.
///
pub async fn get_color_map_wv(&mut self, ) -> Dict {
	self.call_fn_wv("nvim_get_color_map", [();0]).await
}
...
///
pub async fn get_context(&mut self, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_context", (opts, )).await
}
///nvim_get_context({opts})                                  *nvim_get_context()*
///    Gets a map of the current editor state.
///
...
///        map of global |context|.
///
pub async fn get_context_wv(&mut self, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_get_context", (opts, )).await
}
...
///      • {dict}  |Context| map.
///
pub async fn load_context(&mut self, dict: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_load_context", (dict, )).await
}
///nvim_load_context({dict})                                *nvim_load_context()*
///    Sets the current editor state from the given |context| map.
///
...
///      • {dict}  |Context| map.
///
pub async fn load_context_wv(&mut self, dict: Dict, ) -> Object {
	self.call_fn_wv("nvim_load_context", (dict, )).await
}
...
///
pub async fn get_mode(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_mode", [();0]).await
}
///nvim_get_mode()                                              *nvim_get_mode()*
///    Gets the current mode. |mode()| "blocking" is true if Nvim is waiting for
///    input.
...
///        Dict { "mode": String, "blocking": Boolean }
///
pub async fn get_mode_wv(&mut self, ) -> Dict {
	self.call_fn_wv("nvim_get_mode", [();0]).await
}
...
///
pub async fn get_keymap(&mut self, mode: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_keymap", (mode, )).await
}
///nvim_get_keymap({mode})                                    *nvim_get_keymap()*
///    Gets a list of global (non-buffer-local) |mapping| definitions.
///
...
///        "buffer" key is always zero.
///
pub async fn get_keymap_wv(&mut self, mode: String, ) -> Vec<Dict> {
	self.call_fn_wv("nvim_get_keymap", (mode, )).await
}
...
///
pub async fn set_keymap(&mut self, mode: &str, lhs: &str, rhs: &str, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_set_keymap", (mode, lhs, rhs, opts, )).await
}
///nvim_set_keymap({mode}, {lhs}, {rhs}, {opts})              *nvim_set_keymap()*
///    Sets a global |mapping| for the given mode.
///
...
///                  "callback" is equivalent to returning an empty string.
///
pub async fn set_keymap_wv(&mut self, mode: String, lhs: String, rhs: String, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_set_keymap", (mode, lhs, rhs, opts, )).await
}
...
///      • |nvim_set_keymap()|
///
pub async fn del_keymap(&mut self, mode: &str, lhs: &str, ) -> () {
	self.call_fn("nvim_del_keymap", (mode, lhs, )).await
}
...
///
pub async fn get_api_info(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_api_info", [();0]).await
}
///nvim_get_api_info()                                      *nvim_get_api_info()*
///    Returns a 2-tuple (Array), where item 0 is the current channel id and item
///    1 is the |api-metadata| map (Dict).
...
///        2-tuple `[{channel-id}, {api-metadata}]`
///
pub async fn get_api_info_wv(&mut self, ) -> Array {
	self.call_fn_wv("nvim_get_api_info", [();0]).await
}
...
///
pub async fn set_client_info(&mut self, name: &str, version: impl Serialize, type: &str, methods: impl Serialize, attributes: impl Serialize, ) -> () {
	self.call_fn("nvim_set_client_info", (name, version, type, methods, attributes, )).await
}
///                                                      *nvim_set_client_info()*
///nvim_set_client_info({name}, {version}, {type}, {methods}, {attributes})
///    Self-identifies the client, and sets optional flags on the channel.
...
///                        icon. .png or .svg format is preferred.
///
pub async fn set_client_info_wv(&mut self, name: String, version: Dict, type: String, methods: Dict, attributes: Dict, ) -> () {
	self.call_fn_wv("nvim_set_client_info", (name, version, type, methods, attributes, )).await
}
...
///
pub async fn get_chan_info(&mut self, chan: Integer, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_chan_info", (chan, )).await
}
///nvim_get_chan_info({chan})                              *nvim_get_chan_info()*
///    Gets information about a channel.
///
...
///          the channel), as set by |nvim_set_client_info()|.
///
pub async fn get_chan_info_wv(&mut self, chan: Integer, ) -> Dict {
	self.call_fn_wv("nvim_get_chan_info", (chan, )).await
}
...
///
pub async fn list_chans(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_list_chans", [();0]).await
}
///nvim_list_chans()                                          *nvim_list_chans()*
///    Get information about all open channels.
///
...
///        specified at |nvim_get_chan_info()|.
///
pub async fn list_chans_wv(&mut self, ) -> Array {
	self.call_fn_wv("nvim_list_chans", [();0]).await
}
...
///
pub async fn list_uis(&mut self, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_list_uis", [();0]).await
}
///nvim_list_uis()                                              *nvim_list_uis()*
///    Gets a list of dictionaries representing attached UIs.
///
...
///        • "chan" |channel-id| of remote UI
///
pub async fn list_uis_wv(&mut self, ) -> Array {
	self.call_fn_wv("nvim_list_uis", [();0]).await
}
...
///
pub async fn get_proc_children(&mut self, pid: Integer, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_proc_children", (pid, )).await
}
///nvim_get_proc_children({pid})                       *nvim_get_proc_children()*
///    Gets the immediate children of process `pid`.
///
...
///        Array of child process ids, empty if process not found.
///
pub async fn get_proc_children_wv(&mut self, pid: Integer, ) -> Array {
	self.call_fn_wv("nvim_get_proc_children", (pid, )).await
}
...
///
pub async fn get_proc(&mut self, pid: Integer, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_proc", (pid, )).await
}
///nvim_get_proc({pid})                                         *nvim_get_proc()*
///    Gets info describing process `pid`.
///
...
///        Map of process properties, or NIL if process not found.
///
pub async fn get_proc_wv(&mut self, pid: Integer, ) -> Object {
	self.call_fn_wv("nvim_get_proc", (pid, )).await
}
...
///      • {opts}    Optional parameters. Reserved for future use.
///
pub async fn select_popupmenu_item(&mut self, item: Integer, insert: Boolean, finish: Boolean, opts: impl Serialize, ) -> () {
	self.call_fn("nvim_select_popupmenu_item", (item, insert, finish, opts, )).await
}
///                                                *nvim_select_popupmenu_item()*
///nvim_select_popupmenu_item({item}, {insert}, {finish}, {opts})
///    Selects an item in the completion popup menu.
...
///      • {opts}    Optional parameters. Reserved for future use.
///
pub async fn select_popupmenu_item_wv(&mut self, item: Integer, insert: Boolean, finish: Boolean, opts: Dict, ) -> () {
	self.call_fn_wv("nvim_select_popupmenu_item", (item, insert, finish, opts, )).await
}
...
///      • |nvim_get_mark()|
///
pub async fn del_mark(&mut self, name: &str, ) -> Boolean {
	self.call_fn("nvim_del_mark", (name, )).await
}
...
///      • |nvim_del_mark()|
///
pub async fn get_mark(&mut self, name: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_get_mark", (name, opts, )).await
}
///nvim_get_mark({name}, {opts})                                *nvim_get_mark()*
///    Returns a `(row, col, buffer, buffername)` tuple representing the position
///    of the uppercase/file named mark. "End of line" column position is
...
///      • |nvim_del_mark()|
///
pub async fn get_mark_wv(&mut self, name: String, opts: Dict, ) -> Array {
	self.call_fn_wv("nvim_get_mark", (name, opts, )).await
}
...
///            priority last).
///
pub async fn eval_statusline(&mut self, str: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_eval_statusline", (str, opts, )).await
}
///nvim_eval_statusline({str}, {opts})                   *nvim_eval_statusline()*
///    Evaluates statusline string.
///
...
///            priority last).
///
pub async fn eval_statusline_wv(&mut self, str: String, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_eval_statusline", (str, opts, )).await
}
...
///      • |nvim_cmd()|
///
pub async fn exec2(&mut self, src: &str, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_exec2", (src, opts, )).await
}
///nvim_exec2({src}, {opts})                                       *nvim_exec2()*
///    Executes Vimscript (multiline block of Ex commands), like anonymous
///    |:source|.
...
///      • |nvim_cmd()|
///
pub async fn exec2_wv(&mut self, src: String, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_exec2", (src, opts, )).await
}
...
pub async fn command(&mut self, command: &str, ) -> () {
	self.call_fn("nvim_command", (command, )).await
}
...
///
pub async fn eval(&mut self, expr: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_eval", (expr, )).await
}
///nvim_eval({expr})                                                *nvim_eval()*
///    Evaluates a Vimscript |expression|. Dicts and Lists are recursively
///    expanded.
...
///        Evaluation result or expanded object
///
pub async fn eval_wv(&mut self, expr: String, ) -> Object {
	self.call_fn_wv("nvim_eval", (expr, )).await
}
...
///
pub async fn call_function(&mut self, fn: &str, args: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_call_function", (fn, args, )).await
}
///nvim_call_function({fn}, {args})                        *nvim_call_function()*
///    Calls a Vimscript function with the given arguments.
///
...
///        Result of the function call
///
pub async fn call_function_wv(&mut self, fn: String, args: Array, ) -> Object {
	self.call_fn_wv("nvim_call_function", (fn, args, )).await
}
...
///        Result of the function call
///
pub async fn call_dict_function(&mut self, dict: impl Serialize, fn: &str, args: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_call_dict_function", (dict, fn, args, )).await
}
///                                                   *nvim_call_dict_function()*
///nvim_call_dict_function({dict}, {fn}, {args})
///    Calls a Vimscript |Dictionary-function| with the given arguments.
...
///        Result of the function call
///
pub async fn call_dict_function_wv(&mut self, dict: Object, fn: String, args: Array, ) -> Object {
	self.call_fn_wv("nvim_call_dict_function", (dict, fn, args, )).await
}
...
///
///==============================================================================
pub async fn parse_expression(&mut self, expr: &str, flags: &str, highlight: Boolean, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_parse_expression", (expr, flags, highlight, )).await
}
///                                                     *nvim_parse_expression()*
///nvim_parse_expression({expr}, {flags}, {highlight})
///    Parse a Vimscript expression.
...
///
///==============================================================================
pub async fn parse_expression_wv(&mut self, expr: String, flags: String, highlight: Boolean, ) -> Dict {
	self.call_fn_wv("nvim_parse_expression", (expr, flags, highlight, )).await
}
...
///
pub async fn open_win(&mut self, buffer: Buffer, enter: Boolean, config: impl Serialize, ) -> Window {
	self.call_fn("nvim_open_win", (buffer, enter, config, )).await
}
///nvim_open_win({buffer}, {enter}, {config})                   *nvim_open_win()*
///    Opens a new split window, or a floating window if `relative` is specified,
///    or an external window (managed by the UI) if `external` is specified.
...
///        |window-ID|, or 0 on error
///
pub async fn open_win_wv(&mut self, buffer: Buffer, enter: Boolean, config: Dict, ) -> Window {
	self.call_fn_wv("nvim_open_win", (buffer, enter, config, )).await
}
...
///
///==============================================================================
pub async fn win_set_config(&mut self, window: Window, config: impl Serialize, ) -> () {
	self.call_fn("nvim_win_set_config", (window, config, )).await
}
///nvim_win_set_config({window}, {config})                *nvim_win_set_config()*
///    Configures window layout. Cannot be used to move the last window in a
///    tabpage to a different one.
...
///
///==============================================================================
pub async fn win_set_config_wv(&mut self, window: Window, config: Dict, ) -> () {
	self.call_fn_wv("nvim_win_set_config", (window, config, )).await
}
...
///
pub async fn win_get_config(&mut self, window: Window, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_win_get_config", (window, )).await
}
///nvim_win_get_config({window})                          *nvim_win_get_config()*
///    Gets window configuration.
///
...
///        Map defining the window configuration, see |nvim_open_win()|
///
pub async fn win_get_config_wv(&mut self, window: Window, ) -> Dict {
	self.call_fn_wv("nvim_win_get_config", (window, )).await
}
...
///        Buffer id
///
pub async fn win_get_buf(&mut self, window: Window, ) -> Buffer {
	self.call_fn("nvim_win_get_buf", (window, )).await
}
...
///      • {buffer}  Buffer id
///
pub async fn win_set_buf(&mut self, window: Window, buffer: Buffer, ) -> () {
	self.call_fn("nvim_win_set_buf", (window, buffer, )).await
}
...
///      • |getcurpos()|
///
pub async fn win_get_cursor(&mut self, window: Window, ) -> Vec<Integer> {
	self.call_fn("nvim_win_get_cursor", (window, )).await
}
...
///
pub async fn win_set_cursor(&mut self, window: Window, pos: &[Integer], ) -> () {
	self.call_fn("nvim_win_set_cursor", (window, pos, )).await
}
...
///
pub async fn win_get_height(&mut self, window: Window, ) -> Integer {
	self.call_fn("nvim_win_get_height", (window, )).await
}
...
///
pub async fn win_set_height(&mut self, window: Window, height: Integer, ) -> () {
	self.call_fn("nvim_win_set_height", (window, height, )).await
}
...
///
pub async fn win_get_width(&mut self, window: Window, ) -> Integer {
	self.call_fn("nvim_win_get_width", (window, )).await
}
...
///
pub async fn win_set_width(&mut self, window: Window, width: Integer, ) -> () {
	self.call_fn("nvim_win_set_width", (window, width, )).await
}
...
///        Variable value
///
pub async fn win_get_var(&mut self, window: Window, name: &str, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_win_get_var", (window, name, )).await
}
///nvim_win_get_var({window}, {name})                        *nvim_win_get_var()*
///    Gets a window-scoped (w:) variable
///
...
///        Variable value
///
pub async fn win_get_var_wv(&mut self, window: Window, name: String, ) -> Object {
	self.call_fn_wv("nvim_win_get_var", (window, name, )).await
}
...
///      • {value}   Variable value
///
pub async fn win_set_var(&mut self, window: Window, name: &str, value: impl Serialize, ) -> () {
	self.call_fn("nvim_win_set_var", (window, name, value, )).await
}
///nvim_win_set_var({window}, {name}, {value})               *nvim_win_set_var()*
///    Sets a window-scoped (w:) variable
///
...
///      • {value}   Variable value
///
pub async fn win_set_var_wv(&mut self, window: Window, name: String, value: Object, ) -> () {
	self.call_fn_wv("nvim_win_set_var", (window, name, value, )).await
}
...
///      • {name}    Variable name
///
pub async fn win_del_var(&mut self, window: Window, name: &str, ) -> () {
	self.call_fn("nvim_win_del_var", (window, name, )).await
}
...
///
pub async fn win_get_position(&mut self, window: Window, ) -> Vec<Integer> {
	self.call_fn("nvim_win_get_position", (window, )).await
}
...
///
pub async fn win_get_tabpage(&mut self, window: Window, ) -> Tabpage {
	self.call_fn("nvim_win_get_tabpage", (window, )).await
}
...
///        Window number
///
pub async fn win_get_number(&mut self, window: Window, ) -> Integer {
	self.call_fn("nvim_win_get_number", (window, )).await
}
...
///
pub async fn win_is_valid(&mut self, window: Window, ) -> Boolean {
	self.call_fn("nvim_win_is_valid", (window, )).await
}
...
///      • {window}  |window-ID|, or 0 for current window
///
pub async fn win_hide(&mut self, window: Window, ) -> () {
	self.call_fn("nvim_win_hide", (window, )).await
}
...
///
pub async fn win_close(&mut self, window: Window, force: Boolean, ) -> () {
	self.call_fn("nvim_win_close", (window, force, )).await
}
...
///      • {ns_id}   the namespace to use
///
pub async fn win_set_hl_ns(&mut self, window: Window, ns_id: Integer, ) -> () {
	self.call_fn("nvim_win_set_hl_ns", (window, ns_id, )).await
}
...
///
///==============================================================================
pub async fn win_text_height(&mut self, window: Window, opts: impl Serialize, ) -> impl Deserialize<'static> {
	self.call_fn("nvim_win_text_height", (window, opts, )).await
}
///nvim_win_text_height({window}, {opts})                *nvim_win_text_height()*
///    Computes the number of screen lines occupied by a range of text in a given
///    window. Works for off-screen text and takes folds into account.
...
///
///==============================================================================
pub async fn win_text_height_wv(&mut self, window: Window, opts: Dict, ) -> Dict {
	self.call_fn_wv("nvim_win_text_height", (window, opts, )).await
}
}
